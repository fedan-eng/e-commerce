                ...
                {showBanner && (
                  ...
                  >
                    <div className="bg-[#f0fdf4] border border-green-200 text-green-800 px-4 py-3 rounded-xl flex items-center gap-2.5 mb-3">
                      ...
                      <span className="text-[14px] font-roboto font-bold">Added to your cart</span>
                    </div>
              ...
              <div className="flex-shrink-0 border-t border-gray-100 bg-white px-6 py-6 pb-8">
                ...
                <div className="flex items-start justify-between mb-5">
                  <div className="flex flex-col">
                    <span className="text-[15px] font-roboto font-medium text-gray-500">Subtotal</span>
                    <span className="text-[13px] font-roboto text-gray-400 mt-1">
                      {totalItems} {totalItems === 1 ? "item" : "items"} in cart
                    </span>
                  </div>
                  <span className="font-roboto font-bold text-[17px] text-gray-900">
                ...
                <Link
                  ...
                  "
                >
                  Checkout Now ({totalItems}) <span className="font-roboto text-[16px] leading-none">➔</span>
                </Link>

                {/* Continue Shopping Link */}
                <button
                  onClick={() => dispatch(closeCart())}
                  className="w-full text-center text-[13px] font-roboto font-medium text-emerald-500 hover:text-emerald-600 transition-colors underline underline-offset-4 mt-4"
                >
                  Continue Shopping
                </button>
              </div>
  ...
  return (
    ...
    >
      ...
      <div className="w-full">
        <h3 className="text-[15px] font-roboto font-extrabold text-gray-900 leading-snug truncate">
          {item.name}
        </h3>
        {item.color && (
          <p className="text-[13px] font-roboto text-gray-400 mt-1 capitalize">{item.color}</p>
        )}
