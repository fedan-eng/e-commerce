    ...
    Share
          ...
          <div>
            ...
            <div className="flex max-xxs:flex-col gap-2 xxs:gap-4 mt-10 fl">
              ...
              <WishlistButtonPD
                text
                className='max-xxs:order-2 px-6 max-xxs:px-3 py-3 max-xxs:py-2 border border-[#dfdfdf] rounded-md w-fit font-medium text-[#007c42] hover:text-filgreen xs:text-sm whitespace-nowrap transition'
                product={product}
              />
